...
################################################################################
## Form generated from reading UI file 'Supprimer_livre - Copy.ui'
##
...
"")
        ...
        self.frame.setGeometry(QRect(0, 0, 1161, 531))
        ...
        self.label = QLabel(self.Referance)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(270, 110, 261, 101))
        self.lineEdit = QLineEdit(self.Referance)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(560, 150, 161, 31))
        self.pushButton = QPushButton(self.Referance)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(460, 270, 93, 28))
        self.Supprimer.addTab(self.Referance, "")
        self.ISBN = QWidget()
        self.ISBN.setObjectName(u"ISBN")
        self.label_3 = QLabel(self.ISBN)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(250, 140, 261, 81))
        self.pushButton_2 = QPushButton(self.ISBN)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(440, 300, 93, 28))
        self.lineEdit_2 = QLineEdit(self.ISBN)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(530, 170, 161, 31))
        self.Supprimer.addTab(self.ISBN, "")
        self.Titre = QWidget()
        ...
        self.lineEdit_3.setGeometry(QRect(530, 150, 161, 31))
        self.Supprimer.addTab(self.Titre, "")
        self.Auteur = QWidget()
        self.Auteur.setObjectName(u"Auteur")
        self.label_5 = QLabel(self.Auteur)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(280, 140, 171, 51))
        ...
        self.lineEdit_4.setGeometry(QRect(450, 150, 161, 31))
        self.Supprimer.addTab(self.Auteur, "")
        ...
        self.menuMise_a_jour_2.addAction(self.actionModifier_etudiant)
        ...
        self.Supprimer.setCurrentIndex(3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionModifier_etudiant.setText(QCoreApplication.translate("MainWindow", u"Modifier emprunt", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Suppression d une Livre selon", None))
        ...
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Referance), QCoreApplication.translate("MainWindow", u"Referance", None))
        ...
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.ISBN), QCoreApplication.translate("MainWindow", u"ISBN", None))
        ...
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Titre), QCoreApplication.translate("MainWindow", u"Titre", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Auteur :", None))
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Supprimer", None))
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Auteur), QCoreApplication.translate("MainWindow", u"Auteur", None))
