...
################################################################################
## Form generated from reading UI file 'Supprimer_emprunt.ui'
##
...
"")
        ...
        self.Supprimer.setGeometry(QRect(90, 50, 921, 441))
        ...
        self.label_4 = QLabel(self.Date)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(240, 140, 181, 41))
        self.pushButton_3 = QPushButton(self.Date)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(440, 280, 93, 28))
        self.dateEdit = QDateEdit(self.Date)
        self.dateEdit.setObjectName(u"dateEdit")
        self.dateEdit.setGeometry(QRect(510, 160, 110, 22))
        self.Supprimer.addTab(self.Date, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Suppression d une emprunt", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"N\u00b0 Emprunt", None))
        ...
        self.Supprimer.setTabText(self.Supprimer.indexOf(self.Date), QCoreApplication.translate("MainWindow", u"Date", None))
