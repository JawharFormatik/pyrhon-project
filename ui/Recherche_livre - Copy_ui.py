...
################################################################################
## Form generated from reading UI file 'Recherche_livre - Copy.ui'
##
...
"")
        ...
        self.actionRecherche_2 = QAction(MainWindow)
        self.actionRecherche_2.setObjectName(u"actionRecherche_2")
        self.actionModifier_emprunt = QAction(MainWindow)
        self.actionModifier_emprunt.setObjectName(u"actionModifier_emprunt")
        self.actionRecherche_3 = QAction(MainWindow)
        self.actionRecherche_3.setObjectName(u"actionRecherche_3")
        ...
        self.tableWidget.setGeometry(QRect(550, 70, 681, 461))
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(10, 70, 531, 461))
        self.tabWidget.setToolTipDuration(0)
        self.Referance = QWidget()
        self.Referance.setObjectName(u"Referance")
        self.label_11 = QLabel(self.Referance)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(200, 50, 171, 91))
        self.label_11.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.pushButton_2 = QPushButton(self.Referance)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(190, 300, 93, 28))
        self.lineEdit_2 = QLineEdit(self.Referance)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(290, 190, 161, 31))
        self.label_3 = QLabel(self.Referance)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(40, 150, 261, 101))
        self.tabWidget.addTab(self.Referance, "")
        self.Titre = QWidget()
        self.Titre.setObjectName(u"Titre")
        self.label_12 = QLabel(self.Titre)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(190, 30, 171, 91))
        self.label_12.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_4 = QLabel(self.Titre)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(70, 140, 261, 101))
        self.lineEdit_3 = QLineEdit(self.Titre)
        self.lineEdit_3.setObjectName(u"lineEdit_3")
        self.lineEdit_3.setGeometry(QRect(280, 180, 161, 31))
        self.pushButton_3 = QPushButton(self.Titre)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(180, 300, 93, 28))
        self.tabWidget.addTab(self.Titre, "")
        self.Auteur = QWidget()
        self.Auteur.setObjectName(u"Auteur")
        self.label_13 = QLabel(self.Auteur)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(190, 30, 171, 91))
        self.label_13.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_6 = QLabel(self.Auteur)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(70, 140, 261, 101))
        self.lineEdit_4 = QLineEdit(self.Auteur)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(280, 180, 161, 31))
        self.pushButton_4 = QPushButton(self.Auteur)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(180, 280, 93, 28))
        self.tabWidget.addTab(self.Auteur, "")
        self.Num_Examp = QWidget()
        self.Num_Examp.setObjectName(u"Num_Examp")
        self.label_14 = QLabel(self.Num_Examp)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(150, 50, 241, 91))
        self.label_14.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_5 = QLabel(self.Num_Examp)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(90, 120, 261, 101))
        self.lineEdit_5 = QLineEdit(self.Num_Examp)
        self.lineEdit_5.setObjectName(u"lineEdit_5")
        self.lineEdit_5.setGeometry(QRect(280, 160, 161, 31))
        self.pushButton_5 = QPushButton(self.Num_Examp)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(200, 270, 93, 28))
        self.tabWidget.addTab(self.Num_Examp, "")
        self.Page = QWidget()
        self.Page.setObjectName(u"Page")
        self.label_15 = QLabel(self.Page)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(210, 30, 171, 91))
...
"color: rgb(0, 170, 127);")
        ...
        self.lineEdit_6.setGeometry(QRect(280, 150, 161, 31))
        self.pushButton_6 = QPushButton(self.Page)
        self.pushButton_6.setObjectName(u"pushButton_6")
        self.pushButton_6.setGeometry(QRect(200, 260, 93, 28))
        self.tabWidget.addTab(self.Page, "")
        self.ISBN = QWidget()
        self.ISBN.setObjectName(u"ISBN")
        self.label_10 = QLabel(self.ISBN)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(190, 40, 171, 91))
        self.label_10.setStyleSheet(u"font: 87 12pt \"Verdana Pro Cond Black\";\n"
"color: rgb(0, 170, 127);")
        self.label_2 = QLabel(self.ISBN)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(60, 130, 261, 101))
        self.lineEdit = QLineEdit(self.ISBN)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(290, 170, 161, 31))
        self.pushButton = QPushButton(self.ISBN)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(200, 260, 93, 28))
        ...
        self.menuRecherche_Affichage.addAction(self.actionRecherche_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionRecherche_2.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.actionModifier_emprunt.setText(QCoreApplication.translate("MainWindow", u"Modifier emprunt", None))
        self.actionRecherche_3.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Recherhce par :", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Referance", None))
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Referance :", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Referance), QCoreApplication.translate("MainWindow", u"Referance", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Titre", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Titre), QCoreApplication.translate("MainWindow", u"Titre", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Auteur", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Auteur :", None))
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Auteur), QCoreApplication.translate("MainWindow", u"Auteur", None))
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"Numero Examplaire", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Num Examplaire :", None))
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Num_Examp), QCoreApplication.translate("MainWindow", u"Num_Examp", None))
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Page", None))
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"ISBN", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"ISBN :", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Recherche", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.ISBN), QCoreApplication.translate("MainWindow", u"ISBN", None))
